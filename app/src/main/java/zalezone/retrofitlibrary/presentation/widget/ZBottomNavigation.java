...
public class ZBottomNavigation extends FrameLayout{
    ...
    // Static
    private static String TAG = "ZBottomNavigation";
    ...
    private ArrayList<ZBottomNavigationItem> items = new ArrayList<>();
    private ArrayList<View> views = new ArrayList<>();
    //private AHBottomNavigationBehavior<ZBottomNavigation> bottomNavigationBehavior;
    ...
    public ZBottomNavigation(Context context) {
        super(context);
        init(context);
    }

    public ZBottomNavigation(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ZBottomNavigation(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void createClassicItems(LinearLayout linearLayout){
        ...
        for (int i=0;i<items.size();i++){
            ...
            ZBottomNavigationItem item = items.get(itemIndex);
            ...
            icon.setImageDrawable(ZBottomNavigationHelper.getTintDrawable(items.get(i).getDrawable(context),
    ...
    private void updateItems(final int itemIndex, boolean useCallback){
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                icon.setSelected(true);
                ZBottomNavigationHelper.updateTopMargin(icon, inactiveMarginTop, activeMarginTop);
                ZBottomNavigationHelper.updateLeftMargin(notification, notificationInactiveMarginLeft, notificationActiveMarginLeft);
                ZBottomNavigationHelper.updateTextColor(title, itemInactiveColor, itemActiveColor);
                ZBottomNavigationHelper.updateTextSize(title, inactiveSize, activeSize);
                ZBottomNavigationHelper.updateDrawableColor(context, items.get(itemIndex).getDrawable(context), icon,
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && colored) {
                    ...
                    ZBottomNavigationHelper.updateViewBackgroundColor(this, currentColor,
                ...
                icon.setSelected(false);
                ZBottomNavigationHelper.updateTopMargin(icon, activeMarginTop, inactiveMarginTop);
                ZBottomNavigationHelper.updateLeftMargin(notification, notificationActiveMarginLeft, notificationInactiveMarginLeft);
                ZBottomNavigationHelper.updateTextColor(title, itemActiveColor, itemInactiveColor);
                ZBottomNavigationHelper.updateTextSize(title, activeSize, inactiveSize);
                ZBottomNavigationHelper.updateDrawableColor(context, items.get(currentItem).getDrawable(context), icon,
    ...
    private void updateSmallItems(final int itemIndex, boolean useCallback) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                icon.setSelected(true);
                ZBottomNavigationHelper.updateTopMargin(icon, inactiveMargin, activeMarginTop);
                ZBottomNavigationHelper.updateLeftMargin(notification, notificationInactiveMarginLeft, notificationActiveMarginLeft);
                ZBottomNavigationHelper.updateTopMargin(notification, notificationInactiveMarginTop, notificationActiveMarginTop);
                ZBottomNavigationHelper.updateTextColor(title, itemInactiveColor, itemActiveColor);
                ZBottomNavigationHelper.updateAlpha(title, 0, 1);
                ZBottomNavigationHelper.updateWidth(container, notSelectedItemWidth, selectedItemWidth);
                ZBottomNavigationHelper.updateDrawableColor(context, items.get(itemIndex).getDrawable(context), icon,
                        itemInactiveColor, itemActiveColor, forceTint);
                ...
                icon.setSelected(false);
                ZBottomNavigationHelper.updateTopMargin(icon, activeMarginTop, inactiveMargin);
                ZBottomNavigationHelper.updateLeftMargin(notification, notificationActiveMarginLeft, notificationInactiveMarginLeft);
                ZBottomNavigationHelper.updateTopMargin(notification, notificationActiveMarginTop, notificationInactiveMarginTop);
                ZBottomNavigationHelper.updateTextColor(title, itemActiveColor, itemInactiveColor);
                ZBottomNavigationHelper.updateAlpha(title, 1, 0);
                ZBottomNavigationHelper.updateWidth(container, selectedItemWidth, notSelectedItemWidth);
                ZBottomNavigationHelper.updateDrawableColor(context, items.get(currentItem).getDrawable(context), icon,
                        itemActiveColor, itemInactiveColor, forceTint);
        ...
        for (int i=0; i<views.size();i++){
            ...
            if (updateStyle){
                ...
                if (notificationBackgroundDrawable != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        notification.setBackground(ZBottomNavigationHelper.getTintDrawable(defautlDrawable,
                                notificationBackgroundColor, forceTint));
                    } else {
                        notification.setBackgroundDrawable(ZBottomNavigationHelper.getTintDrawable(defautlDrawable,
                                notificationBackgroundColor, forceTint));
                    }
                }
            }
     ...
     * Add an item
     */
    public void addItem(ZBottomNavigationItem item) {
     ...
     * Add all items
     */
    public void addItems(List<ZBottomNavigationItem> items) {
     ...
     */
    public ZBottomNavigationItem getItem(int position) {
